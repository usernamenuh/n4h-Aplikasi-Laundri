  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="../dashboard/index.html" class="b-brand text-primary">
       ...
       <span>Aplikasi Laundri</span>
      </a>
    </div>
    <div class="navbar-content">
      <ul class="pc-navbar">
        <li class="pc-item">
          <a href="{{ route('laundri.index') }}" class="pc-link">
        ...
        <li class="pc-item">
          <a href="{{ route('detail_transaksi.index') }}" class="pc-link">
            <span class="pc-micon"><i class="ti ti-plant-2"></i></span>
            <span class="pc-mtext">Detail Transaksi</span>
          </a>
        </li>
      </ul>
    </div>
          ...
          <div class="row align-items-center">
            <div class="col-md-12">
              <div class="page-header-title">
                <h5 class="m-b-10">@yield('title', 'Home')</h5>
              </div>
              <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('laundri.index') }}">Home</a></li>
                @yield('breadcrumb')
              </ul>
            </div>
          </div>
